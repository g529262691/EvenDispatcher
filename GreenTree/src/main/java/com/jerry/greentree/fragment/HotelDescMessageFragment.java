...
public class HotelDescMessageFragment extends Fragment
{
    ...
    public static HotelDescMessageFragment newInstance(String param1, String param2)
    {
                             ...
                             Bundle savedInstanceState)
    {
        ...
        return inflater.inflate(R.layout.fragment_hotel_desc_message, container, false);
    }
